...
//    assign led[13:8] = floor_state;
    ...
    assign el_state_1 = sw[3:0];
    assign el_state_2 = sw[7:4];
    assign floor_state = sw[13:8];
    
    logic_mgmt(clk, pos_1, pos_2, static_1, static_2, dir_1, dir_2, 0, door_led_1, door_led_2, floor_state, el_state_1, el_state_2, set_1, set_2);
    
    display_floor(clk, pos_2, pos_1, an, seg);
        
    assign led[2:0] = set_1;
    assign led[5:3] = set_2;
