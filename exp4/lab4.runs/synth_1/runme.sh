...
HD_PWD='D:/University/Engineering/8th semester/Digital Lab/lab-digitales/exp4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_ale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_ale.tcl
