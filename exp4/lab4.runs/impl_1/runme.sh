...
HD_PWD='D:/University/Engineering/8th semester/Digital Lab/lab-digitales/exp4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_ale.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_ale.tcl -notrace
